...
exports.accountConfirmTemplate = `
<!DOCTYPE html
                    ...
                    <tr>
                        <td align="center" valign="top" style="padding:0 25px;" class="em_aside10">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <a href="{{ firmUrl }}" target="_blank" style="text-decoration:none;">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                ...
                                <tr>
                                    <td class="em_grey" align="center" valign="top"
                                        ...
                                        Kliknite na dugme ispod da potvrdite nalog.
                                    </td>
                                </tr>
                                <tr>
                                            ...
                                            <tr>
                                                <td class="em_white" height="42" align="center" valign="middle"
                                                    ...
                                                    <a href="{{ confirmUrl }}" target="_blank"
                                                        style="text-decoration:none; color:#ffffff; line-height:42px; display:block;">POTVRDI
                                                        NALOG</a>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td class="em_grey" align="center" valign="top"
                                        style="font-family: Arial, sans-serif; font-size: 16px; line-height: 26px; color:#434343;">
                                        Ako niste napravili nalog, ignorišite ovaj mejl.
                                    </td>
                                </tr>
                                <tr>
...
//# sourceMappingURL=account-confirm.handlebars.js.map