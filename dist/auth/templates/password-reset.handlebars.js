                ...
                <tr>
                  <td align="center" valign="top">
                    <a href="#" target="_blank" style="text-decoration:none;">
                      <h1 width="208" height="41" border="0"
                        style="display:block; font-family:Arial, sans-serif; font-size:38px; line-height:40px; text-align:center; color:#1d4685; font-weight:bold; max-width:208px;"
                        class="em_w150">
                        {{ firmName }}
                      </h1>
                      <!-- <img
    ...
    <tr>
      <td align="center" valign="top" class="em_aside5">
        <table align="center" width="650" border="0" cellspacing="0" cellpadding="0" class="em_main_table"
          ...
          <tr>
            <td align="center" valign="top" style="padding:0 25px; background-color:#ffffff;" class="em_aside10">
              <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                ...
                <tr>
                  <td align="center" valign="top">
                    <table width="250" style="width:250px; background-color:#6bafb2; border-radius:4px;" border="0"
                      ...
                      <tr>
                        <td class="em_white" height="42" align="center" valign="middle"
                          ...
                          <a href="{{ resetUrl }}" target="_blank"
                            style="text-decoration:none; color:#ffffff; line-height:42px; display:block;">RESETUJ
                            ŠIFRU</a>
                        </td>
                      </tr>
                    </table>
                ...
                <tr>
                  <td class="em_grey" align="center" valign="top"
                    style="font-family: Arial, sans-serif; font-size: 16px; line-height: 26px; color:#434343;">
                    Ako niste zahtevali novu lozinku, ignorišite ovaj mejl.
                  </td>
                </tr>
                <tr>
          ...
          <tr>
            <td class="em_grey" align="center" valign="top"
              style="font-family: Arial, sans-serif; font-size: 15px; line-height: 26px; color:#656565;">
              test@example.com +381000000
...
//# sourceMappingURL=password-reset.handlebars.js.map